...
app.get('/allProducts', function (req, res, next) {
    ...
    'm.BRAND,d.LIST_PRICE,d.DISCOUNT,d.IN_STOCK,d.PRICE_EFFECTIVE_DATE from sampledb.XXIBM_PRODUCT_SKU s inner join XXIBM_PRODUCT_STYLE m on s.STYLE_ITEM = m.ITEM_NUMBER'+
    ' inner join XXIBM_PRODUCT_PRICING d on d.ITEM_NUMBER = s.ITEM_NUMBER;', function (err, rows, fields) {
